      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            ?>
            <form class="form-signin" method="post" action="action/insert-reg.php">
              <div class="form-label-group">
                <label for="inputEmail">Enter your first name <font color="red">*</font></label>
                <br/>
                <input type="text" id="inputEmail" name="fname" class="form-control" placeholder="Enter your first name" required autofocus>
                
              </div>

              <div class="form-label-group">
                <label for="inputEmail">Enter your last name<font color="red">*</font></label>
                <input type="text" id="inputEmail" name="lname" class="form-control" placeholder="Enter your last name" required autofocus>
                
              </div>

              <div class="form-label-group">
                <label for="inputPassword">Enter your Email Id<font color="red">*</font></label>
                <input type="text" id="inputPassword" name="emailid" class="form-control" placeholder="Enter your emailid" required>
                
              </div>

              <div class="form-label-group">
                <label for="inputPassword">Enter your phn no<font color="red">*</font></label>
                <input type="phoneno" id="inputPassword" name="phnno" class="form-control" placeholder="Enter your phoneno" required>
                 
              </div>
              <div class="form-label-group">
                <label for="inputPassword">Enter your address<font color="red">*</font></label>
                <input type="text" name="address" id="inputPassword" class="form-control" placeholder="Enter your address" required>
              </div>
                <div class="form-label-group">
              ...
              <div class="form-label-group">
                ...
                <input type="password" id="inputPassword" name="conpass" class="form-control" placeholder="Re-enter Password" required>
