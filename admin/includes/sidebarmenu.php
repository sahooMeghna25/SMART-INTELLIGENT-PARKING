       ...
       <div class="menu">
				<ul id="menu" >
				 ...
				 <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> Location</span> <span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
					   ...
					   <li id="menu-academico-avaliacoes" ><a href="state.php">All Location</a></li>
						<!--<li id="menu-academico-avaliacoes" ><a href="city.php">City</a></li>-->
					  </ul>
				</li>
				 <li id="menu-academico" ><a href="vehicletype.php"><i class="fa fa-users" aria-hidden="true"></i><span>Vehicle Type</span><div class="clearfix"></div></a></li>
